  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.linksCol}>
        ...
        <a
          href="https://music.yandex.com/artist/4746504"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.link}
        >
      ...
      <p className={styles.text}>
        Мы представлены в социальных сетях — присоединяйтесь и пишите при
        необходимости. Для индивидуальных обращений используйте форму обратной
        связи.
      </p>
    </div>
  );
